...
extern const u8 BattleScript_NuzlockeSafariEncounterUsed[];
extern const u8 BattleScript_NuzlockeSafariLegendaryBlocked[];
extern const u8 BattleScript_NuzlockeSafariDuplicateBlocked[];
