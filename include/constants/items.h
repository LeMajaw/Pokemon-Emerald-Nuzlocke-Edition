...
// Nuzlocke: stands in for trading, which is disabled. Used on a trade-evolution
// Pokemon to trigger its trade evolution (see ItemUseCB_LinkStone).
#define ITEM_LINK_STONE 377
