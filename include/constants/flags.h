...
#define FLAG_NUZLOCKE_DUPES_CLAUSE 0x21 // Nuzlocke: Dupes Clause enabled for this run (was FLAG_UNUSED_0x021; clear = dupes allowed, the default for existing saves)
