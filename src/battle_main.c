...
const u8 gTypeEffectiveness[384] =
{
    TYPE_BUG, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BUG, TYPE_FAIRY, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_BUG, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ELECTRIC, TYPE_ELECTRIC, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_ELECTRIC, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FAIRY, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GROUND, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_ICE, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_POISON, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
